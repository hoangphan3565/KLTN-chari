class Donator {
  ...
  Donator(this.id, this.full_name,this.address, this.phone_number,this.username,this.avatar_url,this.favorite_project,this.favorite_notification,this.token) {}
